...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 1, 2024 at 08:50 PM
...
INSERT INTO `oneuser` (`UserID`, `Name`, `Age`, `Gender`, `Height`, `Weight`) VALUES
(1, 'John Doe', 25, 'Male', 175.50, 70.00),
(2, 'Jane Smith', 30, 'Female', 160.20, 55.00),
(3, 'Sarah Connor', 40, 'Female', 165.70, 65.00),
(4, 'Nathan Oaks', 30, 'Male', 185.30, 90.00),
(5, 'Noura Shear', 28, 'Female', 160.40, 55.00),
(6, 'Marwa Chbeir', 90, 'Female', 200.40, 60.00),
(7, 'David Wilson', 33, 'Male', 175.00, 90.00),
(8, 'Olivia Martinez', 27, 'Female', 160.00, 50.00),
(9, 'Daniel Garcia', 38, 'Male', 182.50, 78.00),
(10, 'Sophia Clark', 26, 'Female', 165.50, 63.00);
...
(1, '2024-11-27', 1, 1, 30.00),
(2, '2024-11-29', 2, 2, 45.00),
(3, '2024-11-29', 3, 3, 60.00),
(4, '2024-12-2', 3, 5, 20.00),
(5, '2024-12-3', 2, 6, 15.00),
(6, '2024-12-3', 6, 5, 55.00),
(7, '2024-12-3', 10, 10, 105.00),
(8, '2024-12-3', 9, 4, 35.00),
(9, '2024-12-5', 10, 5, 90.00),
(10, '2024-12-5', 7, 8, 45.00),
(11, '2024-12-6', 5, 2, 50.00),
(12, '2024-12-7', 6, 1, 40.00),
(13, '2024-12-8', 7, 8, 70.00),
(14, '2024-12-8', 8, 10, 50.00);
